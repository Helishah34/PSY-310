...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\Admin\\Downloads\\PSY310- Tutorials\\staircase\\adaptive staircase_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    for thisStair in stair:
        ...
        thisExp.addData('key-resp.corr',key_resp.corr)
        # check responses
