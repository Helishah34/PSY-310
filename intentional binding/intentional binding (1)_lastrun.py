...
expName = 'intentional binding (1)'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\Admin\\Downloads\\MONSOON 2024\\PSY310- Tutorials\\intentional binding\\intentional binding (1)_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    text = visual.TextStim(win=win, name='text',
        text='Report the delay between the key press and the beep sound (0,999); Click submit after entering entering the value',
        font='Arial',
    ...
    trials = data.TrialHandler(nReps=33.0, method='random', 
        ...
        trialList=data.importConditions('intentionalbinding_conditions.xlsx'),
