...
expName = 'word prime'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\Admin\\Downloads\\MONSOON 2024\\PSY310- Tutorials\\Word priming\\word prime_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    trials = data.TrialHandler(nReps=1.0, method='random', 
        ...
        trialList=data.importConditions('word_priming_cond_r1.csv'),
    ...
    trials_2 = data.TrialHandler(nReps=1.0, method='random', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions('word_priming_cond_r2 - Sheet1 (1).csv'),
    ...
    for thisTrial_2 in trials_2:
        ...
        # keep track of which components have finished
        testphaseComponents = [text_2, textbox, text_3, mouse]
