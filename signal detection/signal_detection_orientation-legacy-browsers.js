/************************************* 
 * Signal_Detection_Orientation *
 *************************************/


// store info about the experiment session:
let expName = 'signal_detection_orientation';  // from the Builder filename that created this script
let expInfo = {
...
async function experimentInit() {
  ...
  if ((Math.random() > 0.5)) {
      ...
      tilt = Number.parseInt(util.randint((- 5), 5));
      corrAns = "down";
  }
...
function trialRoutineEnd(snapshot) {
  return async function () {
    ...
    if ((Math.random() > 0.5)) {
        ...
        tilt = Number.parseInt(util.randint((- 5), (- 1)));
        corrAns = "down";
    }
