...
expName = 'signal_detection_orientation'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\Admin\\Downloads\\PSY310- Tutorials\\signal detection\\signal_detection_orientation_lastrun.py',
